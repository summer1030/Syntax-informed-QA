...
def squad_convert_example_to_features(
    ...
    for span in spans:
        ...
        con_info = pickle.load(open(os.path.join(graph_data_path,'constituency_graphs',example.qas_id),'rb'))
        dep_info = pickle.load(open(os.path.join(graph_data_path,'dependency_graphs',example.qas_id),'rb'))
        ...
        features.append(
            ExtendedSquadFeatures(
                ...
                t2v_edge_index = con_info['token_to_virtual_edges'],
                v2v_edge_index = con_info['virtual_to_virtual_edges'],
                t2t_edge_index = dep_info['subword2word'],
                added_node_mapping = dep_info['added_node_embeds_mapping'],
                type0_edge_index = dep_info[dep_type_mapping['type0']],
                type1_edge_index = dep_info[dep_type_mapping['type1']],
                type2_edge_index = dep_info[dep_type_mapping['type2']],
                type3_edge_index = dep_info[dep_type_mapping['type3']],
                type4_edge_index = dep_info[dep_type_mapping['type4']],
                type5_edge_index = dep_info[dep_type_mapping['type5']],
                type6_edge_index = dep_info[dep_type_mapping['type6']],
                type7_edge_index = dep_info[dep_type_mapping['type7']],
                type8_edge_index = dep_info[dep_type_mapping['type8']],
                type9_edge_index = dep_info[dep_type_mapping['type9']],
                type10_edge_index = dep_info[dep_type_mapping['type10']],
                type11_edge_index = dep_info[dep_type_mapping['type11']],
                type12_edge_index = dep_info[dep_type_mapping['type12']],
                type13_edge_index = dep_info[dep_type_mapping['type13']],
                type14_edge_index = dep_info[dep_type_mapping['type14']],
                type15_edge_index = dep_info[dep_type_mapping['type15']],
                type16_edge_index = dep_info[dep_type_mapping['type16']],
                type17_edge_index = dep_info[dep_type_mapping['type17']],
                type18_edge_index = dep_info[dep_type_mapping['type18']],
                type19_edge_index = dep_info[dep_type_mapping['type19']],
                type20_edge_index = dep_info[dep_type_mapping['type20']],
                type21_edge_index = dep_info[dep_type_mapping['type21']],
                type22_edge_index = dep_info[dep_type_mapping['type22']],
                type23_edge_index = dep_info[dep_type_mapping['type23']],
                type24_edge_index = dep_info[dep_type_mapping['type24']],
                type25_edge_index = dep_info[dep_type_mapping['type25']],
                type26_edge_index = dep_info[dep_type_mapping['type26']],
                type27_edge_index = dep_info[dep_type_mapping['type27']],
                type28_edge_index = dep_info[dep_type_mapping['type28']],
                type29_edge_index = dep_info[dep_type_mapping['type29']],
                type30_edge_index = dep_info[dep_type_mapping['type30']],
                type31_edge_index = dep_info[dep_type_mapping['type31']],
                type32_edge_index = dep_info[dep_type_mapping['type32']],
                type33_edge_index = dep_info[dep_type_mapping['type33']],
                type34_edge_index = dep_info[dep_type_mapping['type34']],
                type35_edge_index = dep_info[dep_type_mapping['type35']],
                type36_edge_index = dep_info[dep_type_mapping['type36']],
                type37_edge_index = dep_info[dep_type_mapping['type37']],
                type38_edge_index = dep_info[dep_type_mapping['type38']],
                type39_edge_index = dep_info[dep_type_mapping['type39']],
                type40_edge_index = dep_info[dep_type_mapping['type40']],
                type41_edge_index = dep_info[dep_type_mapping['type41']],
                type42_edge_index = dep_info[dep_type_mapping['type42']],
                type43_edge_index = dep_info[dep_type_mapping['type43']],
            )
        )
    return features
...
def squad_convert_examples_to_features(
    ...
    threads=1,
    tqdm_enabled=True,
    graph_data_path="./data/squad_files/",
):
    """
        ...
        if not is_training:
            ...
            for i, f in enumerate(features):
                ...
                dataset.append(SquadData(input_ids=torch.tensor(f.input_ids, dtype=torch.long),
                            ...
                            p_mask=torch.tensor(f.p_mask, dtype=torch.float),
                            #t2t_edge_index=f.t2t_edge_index,
                            t2t_edge_index=torch.transpose(torch.tensor(f.t2t_edge_index,dtype=torch.long),0,1),
                            t2v_edge_index=torch.transpose(torch.tensor(f.t2v_edge_index,dtype=torch.long),0,1),
                            v2v_edge_index=torch.transpose(torch.tensor(f.v2v_edge_index,dtype=torch.long),0,1),
                            type0_edge_index = torch.transpose(torch.tensor(f.type0_edge_index,dtype=torch.long),0,1),
